...
INSERT INTO users (id,email,hashedpassword,salt,passwordversion,signattempts,lastsignattempt,name,locale,address_id,active,admin,manager,registertime,laboratory_id)
