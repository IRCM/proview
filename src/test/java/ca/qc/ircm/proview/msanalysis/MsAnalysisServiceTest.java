...
public class MsAnalysisServiceTest {
  ...
  public void undoFailed_Ban_Transfer() {
    ...
    assertEquals(true, tube.isBanned());
    Well spot = entityManager.find(Well.class, 1472L);
  ...
  public void undoFailed_Ban_Fractionation() {
    ...
    assertEquals(true, tube.isBanned());
    Well spot = entityManager.find(Well.class, 1473L);
    assertEquals(true, spot.isBanned());
    spot = entityManager.find(Well.class, 1485L);
    assertEquals(true, spot.isBanned());
    Collection<SampleContainer> bannedContainers = sampleContainersCaptor.getValue();
  ...
  public void undoFailed_Ban_Transfer_Fractionation() {
    ...
    assertEquals(true, tube.isBanned());
    Well spot = entityManager.find(Well.class, 1474L);
    assertEquals(true, spot.isBanned());
    spot = entityManager.find(Well.class, 1568L);
    assertEquals(true, spot.isBanned());
    spot = entityManager.find(Well.class, 1580L);
    assertEquals(true, spot.isBanned());
    Collection<SampleContainer> bannedContainers = sampleContainersCaptor.getValue();
  ...
  public void undoFailed_Ban_Fractionation_Transfer() {
    ...
    assertEquals(true, tube.isBanned());
    Well spot = entityManager.find(Well.class, 1475L);
    assertEquals(true, spot.isBanned());
    spot = entityManager.find(Well.class, 1487L);
    assertEquals(true, spot.isBanned());
    spot = entityManager.find(Well.class, 1569L);
    assertEquals(true, spot.isBanned());
    spot = entityManager.find(Well.class, 1581L);
    assertEquals(true, spot.isBanned());
    Collection<SampleContainer> bannedContainers = sampleContainersCaptor.getValue();
