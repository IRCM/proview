...
public class SubmissionActivityServiceTest {
  ...
  public void forceUpdate() {
    ...
    injectionTypeActivity.setTableName("submission");
    injectionTypeActivity.setRecordId(newSubmission.getId());
    injectionTypeActivity.setColumn("injectionType");
    ...
    quantificationCommentActivity.setTableName("submission");
    quantificationCommentActivity.setRecordId(newSubmission.getId());
    quantificationCommentActivity.setColumn("quantificationComment");
