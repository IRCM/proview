...
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.CONTROL_TYPE;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.EXAMPLE;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.FILL_BUTTON_STYLE;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.FILL_STANDARDS;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.HEADER;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.NAME;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.QUANTITY;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.SAMPLE_PANEL;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.SAVE;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARD;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARDS;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARDS_PANEL;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARD_COMMENTS;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARD_COUNT;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARD_NAME;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.STANDARD_QUANTITY;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.SUPPORT;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.TITLE;
import static ca.qc.ircm.proview.sample.web.ControlViewPresenter.VOLUME;
...
public class ControlViewPresenterTest {
  ...
  private String justification = "test justification";
  ...
  public void beforeTest() {
    ...
    view.justificationLayout = new VerticalLayout();
    view.justificationField = new TextField();
  ...
  public void required() {
    ...
    assertTrue(view.justificationField.isRequiredIndicatorVisible());
  }
  ...
  public void editable_True_Update() {
    ...
    assertFalse(standardCommentsField.isReadOnly());
    assertTrue(view.fillStandardsButton.isVisible());
    assertTrue(view.justificationLayout.isVisible());
    assertTrue(view.saveButton.isVisible());
  }
  ...
  public void save_MissingJustification() throws Throwable {
    ...
    assertEquals(generalResources.message(FIELD_NOTIFICATION), stringCaptor.getValue());
    assertEquals(errorMessage(generalResources.message(REQUIRED)),
        view.justificationField.getErrorMessage().getFormattedHtmlMessage());
  ...
  public void save_Update() {
    ...
    verify(view, never()).showError(any());
    verify(controlService).update(controlCaptor.capture(), eq(justification));
  ...
  public void enter_Empty() {
    ...
    assertEquals(SampleSupport.SOLUTION, view.supportField.getValue());
    assertEquals("", view.quantityField.getValue());
    assertEquals("", view.volumeField.getValue());
    assertEquals(ControlType.NEGATIVE_CONTROL, view.controlTypeField.getValue());
    assertEquals("0", view.standardCountField.getValue());
    assertEquals(0, dataProvider(view.standardsGrid).getItems().size());
    assertEquals("", view.justificationField.getValue());
  }
