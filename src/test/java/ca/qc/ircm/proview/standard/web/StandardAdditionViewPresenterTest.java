...
public class StandardAdditionViewPresenterTest {
  ...
  private void setFields() {
    final ListDataProvider<TreatmentSample> treatments = dataProvider(design.standardAdditions);
    int count = 0;
  ...
  public void save_NoName() {
    ...
    presenter.enter("");
    setFields();
    TreatmentSample ts = dataProvider(design.standardAdditions).getItems().iterator().next();
    TextField field =
        (TextField) design.standardAdditions.getColumn(NAME).getValueProvider().apply(ts);
    field.setValue("");
  ...
  public void save() {
    ...
    for (int i = 0; i < containers.size(); i++) {
      ...
      TreatmentSample diluted = standardAddition.getTreatmentSamples().get(i);
  ...
  public void save_Update() {
    ...
    for (int i = 0; i < standardAddition.getTreatmentSamples().size(); i++) {
      TreatmentSample original = standardAddition.getTreatmentSamples().get(i);
      TreatmentSample diluted = savedStandardAddition.getTreatmentSamples().get(i);
  ...
  public void enter() {
    ...
    List<TreatmentSample> tss = new ArrayList<>(dataProvider(design.standardAdditions).getItems());
  ...
  public void enter_StandardAdditionNotId() {
    ...
    ListDataProvider<TreatmentSample> tss = dataProvider(design.standardAdditions);
