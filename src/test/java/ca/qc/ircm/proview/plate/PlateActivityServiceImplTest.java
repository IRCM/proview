...
public class PlateActivityServiceImplTest {
  private PlateActivityServiceImpl plateActivityServiceImpl;
  @PersistenceContext
  ...
  public void beforeTest() {
    plateActivityServiceImpl = new PlateActivityServiceImpl(entityManager, authorizationService);
