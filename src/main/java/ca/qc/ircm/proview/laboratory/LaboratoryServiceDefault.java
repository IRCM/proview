...
@Service
@Transactional
public class LaboratoryServiceDefault implements LaboratoryService {
  private final Logger logger = LoggerFactory.getLogger(LaboratoryServiceDefault.class);
  @PersistenceContext
  ...
  protected LaboratoryServiceDefault() {
  }

  protected LaboratoryServiceDefault(EntityManager entityManager, CacheFlusher cacheFlusher,
