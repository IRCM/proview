...
public class DilutionActivityServiceImpl implements DilutionActivityService {
  @PersistenceContext
  private EntityManager entityManager;
  @Inject
  private AuthorizationService authorizationService;

  protected DilutionActivityServiceImpl() {
  }

  protected DilutionActivityServiceImpl(EntityManager entityManager,
