...
public class SolubilisationActivityServiceImpl implements SolubilisationActivityService {
  @PersistenceContext
  private EntityManager entityManager;
  @Inject
  private AuthorizationService authorizationService;

  protected SolubilisationActivityServiceImpl() {
  }

  protected SolubilisationActivityServiceImpl(EntityManager entityManager,
  ...
  @Override
  public Activity undoErroneous(final Solubilisation solubilisation, final String justification) {
    User user = authorizationService.getCurrentUser();
