...
public class DatePickerInternationalization {
  ...
  public static DatePickerI18n englishDatePickerI18n() {
    return new DatePickerI18n().setWeek("Week").setToday("Today").setCancel("Cancel")
        .setFirstDayOfWeek(0)
  ...
  public static DatePickerI18n frenchDatePickerI18n() {
    return new DatePickerI18n().setWeek("Semaine").setToday("Aujourd'hui").setCancel("Annuler")
        .setFirstDayOfWeek(0)
