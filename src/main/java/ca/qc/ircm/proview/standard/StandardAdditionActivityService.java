...
public class StandardAdditionActivityService {
  ...
  public Optional<Activity> update(StandardAddition standardAddition, String explanation) {
    User user = authorizationService.getCurrentUser();
    final StandardAddition oldStandardAddition = repository.findOne(standardAddition.getId());

    final Collection<UpdateActivityBuilder> updateBuilders = new ArrayList<>();
    Map<Long, TreatedSample> oldTreatedSampleIds = oldStandardAddition.getTreatedSamples().stream()
