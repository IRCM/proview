...
public class StandardAdditionActivityServiceImpl implements StandardAdditionActivityService {
  @PersistenceContext
  private EntityManager entityManager;
  @Inject
  private AuthorizationService authorizationService;

  protected StandardAdditionActivityServiceImpl() {
  }

  protected StandardAdditionActivityServiceImpl(EntityManager entityManager,
