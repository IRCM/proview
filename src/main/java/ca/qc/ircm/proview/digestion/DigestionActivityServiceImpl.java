...
public class DigestionActivityServiceImpl implements DigestionActivityService {
  @PersistenceContext
  private EntityManager entityManager;
  @Inject
  private AuthorizationService authorizationService;

  protected DigestionActivityServiceImpl() {
  }

  protected DigestionActivityServiceImpl(EntityManager entityManager,
