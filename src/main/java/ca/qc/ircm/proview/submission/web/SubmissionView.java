...
public class SubmissionView extends VerticalLayout
  ...
  void init() {
    ...
    digestion.setId(PROTEOLYTIC_DIGESTION_METHOD);
    digestion.setItems(ProteolyticDigestion.values());
    digestion.setItemLabelGenerator(value -> value.getLabel(getLocale()));
    usedDigestion.setId(USED_PROTEOLYTIC_DIGESTION_METHOD);
    otherDigestion.setId(OTHER_PROTEOLYTIC_DIGESTION_METHOD);
    ...
    identificationLink.setId(PROTEIN_IDENTIFICATION_LINK);
