...
public class EnrichmentViewPresenter implements BinderValidator {
  ...
  private List<TreatmentSample> enrichments = new ArrayList<>();
  private ListDataProvider<TreatmentSample> enrichmentsDataProvider = DataProvider.ofItems();
  private Map<TreatmentSample, Binder<TreatmentSample>> enrichmentBinders = new HashMap<>();
