...
public class ValidateViewDefault extends ValidateDesign
    implements ValidateView, MessageResourcesView {
  private static final long serialVersionUID = -1956061543048432065L;
  private static final Logger logger = LoggerFactory.getLogger(ValidateViewDefault.class);
  @Inject
